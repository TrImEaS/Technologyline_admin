  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-full">
      <div className="flex flex-col text-black w-4/5 gap-y-[1px] mt-5 min-h-[400px] rounded-lg border border-gray-300">
        <section className="flex w-full text-black bg-white bg-opacity-90 p-1 rounded-t-lg">
        ...
        {displayedArticles && displayedArticles.map((data, index) => (
          <section 
            ...
            className="flex focus:bg-blue-400 cursor-pointer w-full select-none text-white bg-white bg-opacity-20 p-1 first:rounded-t-lg last:rounded-b-lg">
            <header className="flex gap-3 pl-4 items-center w-full border-dashed border-r border-gray-300">
        ...
        {selectedMail && 
          <section className="bg-slate-800 bg-opacity-85 text-white p-4 z-30 rounded-lg flex flex-col w-3/4 h-[500px] absolute top-[10%] left-[12.5%]">
